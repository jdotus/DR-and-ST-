...
<!-- Row 6: merged 7-9 -->
           ...
           <!-- Row 27: merged 7-9 -->
            <tr style="height: 15px;">
                ...
                <td></td>
                <td></td>
                <td colspan="6" class="merged-block" style="font-weight: bold;text-align: left;">PR No. 1407</td>
                <td></td>
            </tr>
            <!-- Row 28: merged 7-9 -->
            <tr style="height: 15px;">
...
<!-- Row 6: merged 7-9 -->
           ...
           <!-- Row 27: merged 7-9 -->
            ...
            <tr style="height: 15px;">
                ...
                <td></td>
                <td></td>
                <td colspan="3" class="merged-block" ></td>
                <td></td>
            </tr>

            <!-- Row 31: merged 7-9 -->
            <tr style="height: 15px;">
                <td colspan="2" class="merged-block"></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr style="height: 12px;">
                ...
                <td></td>
                <td></td>
                <td colspan="4" class="merged-block" style="font-weight: bold; font-size: 9px; text-align: left;">
                    10F MG Tower #75 Brgy. Daang Bakal Shaw Blvd.
                </td>
            ...
            <tr style="height: 15.75px;">
                ...
                <td colspan="6" class="merged-block" style="text-align: left;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 12px">
                    LTO Comp. East Ave, Diliman, Quezon City
                </td>
                <td></td>
            </tr>
