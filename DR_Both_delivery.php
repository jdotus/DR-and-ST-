        ...
        <div class="portrait-container">
            <table>
                <tr class="dr-row">
                    <td class="col-si-number">
                        <br>
                        <?= htmlspecialchars($siNo[0])?>
                    </td>
                    <td class="col-sold-to">
                         <?= htmlspecialchars($deliveredTo[0])?><br>
                         <?= htmlspecialchars($tin[0])?>
                    </td>
                </tr>
                <tr class="dr-row">
                    <td class="col-si-date"><br> <?= htmlspecialchars($date[0])?></td>
                    <td class="col-sold-to"> <?= htmlspecialchars($address[0])?></td>
                </tr>
                <tr class="dr-row">
                    <td class="col-terms"><br> <?= htmlspecialchars($terms[0])?></td>
                    <td class="col-particulars"> <?= htmlspecialchars($particulars[0])?></td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr class="dr-2nd-row">
                    ...
                    <td class="text-align" style="font-size: 10px">Deliver Machine<br>Model: <?= htmlspecialchars($machineModel[0]) ?></td>
                </tr>
